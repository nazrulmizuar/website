import { r as registerInstance, n as Build, h, j as Host, k as getElement } from './index-4f08d556.js';
import { a as isPlatform, c as config, g as getIonMode } from './ionic-global-90bce0a7.js';
    ...
    if (Build.isBrowser) {
      rIC(async () => {
        ...
        if (!config.getBoolean('_testing')) {
          import('./tap-click-aa6f92c1.js').then(module => module.startTapClick(config));
        }
        if (config.getBoolean('statusTap', isHybrid)) {
          import('./status-tap-8d241663.js').then(module => module.startStatusTap());
        }
        if (config.getBoolean('inputShims', needInputShims())) {
          import('./input-shims-51477ea3.js').then(module => module.startInputShims(config));
        }
